...
function Validate() {
    ...
    if ($("#moTaNgan").val().trim() === "") {
        $("#moTaNgan").css("border-color", "red")
        isValid = false;
    }
    else {
        $("#moTaNgan").css("border-color", "lightgrey")
    }
                ...
                data.forEach((item, index) => {
                    $('#productList').append(`
								<tr>								
									...
									<td>${item.shortDescription ? item.shortDescription : "Dang cap nhat"}</td>
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data) {
                ...
                $('#gia').val(data.price);
                $('#danhGia').val(data.vote);
                $('#moTa').val(data.description);
                $('#moTaNgan').val(data.shortDescription);
